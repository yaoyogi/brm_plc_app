...
We are using the following in pubspec.yaml
 ...
 class TopLevelStateProvider extends ChangeNotifier {
    ...
    ProcessesScreenAppState someScreenAppState = ProcessesScreenAppState();
    ...
...
use a ChangeNotifier with the app state.  Note ProcessesScreenAppState extends ChangeNotifier and calls
...
class ProcessesScreenAppState extends ChangeNotifier {
...
class _ProcessesScreenEphemeralState extends State {
  ProcessesScreenAppState _as ;  // Filled in _appStateBuild()
...
//        _buildValveToggleButtons2(),
  ...
  _appStateBuild() {
    ...
    _as = provider.processesScreenAppState ;
  ...
  dispose() {
    ...
    // Remember that you are preserving the ProcessesScreenAppState outside of this context; it is held
  ...
  @override
  didUpdateWidget(ProcessesScreenWidget oldWidget) {
...
class ProcessesScreenWidget extends StatefulWidget {
  @override
  _ProcessesScreenEphemeralState createState() {
    return _ProcessesScreenEphemeralState();
  }
}
