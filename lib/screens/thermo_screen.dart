...
//use a ChangeNotifier with the app state.  Note ThermoScreenAppState extends ChangeNotifier and calls
...
//
//class ThermoScreenAppState extends ChangeNotifier {
...
//  ThermoScreenAppState _as ;  // Filled in _appStateBuild()
//
//  //
//  // Ephemeral State
//  //
...
//    _as = provider.thermoScreenAppState ;
//
//    //
//    // General
//    //
//    _timestampTEC.text = _as.aggr.timestamp.toString() ;
//    _processAndStatusTEC.text = 'Thermo system active' ;
//
//    //
//    // Temperature
//    //
//    _temperature_1TEC.text = _as.aggr.temp_1.fahrenheit.toString() ;
//    _temperature_2TEC.text = _as.aggr.temp_2.fahrenheit.toString() ;
//    _temperature_3TEC.text = _as.aggr.temp_3.fahrenheit.toString() ;
//
//    // RTD Mod-B
//    _temperature_5TEC.text = _as.aggr.temp_5.fahrenheit.toString() ;
//    _temperature_6TEC.text = _as.aggr.temp_6.fahrenheit.toString() ;
//
//    //
//    // Pressure
//    //
//    _pressure_1TEC.text = _as.aggr.pressure_1.psi.toString() ;
//    _pressure_2TEC.text = _as.aggr.pressure_2.psi.toString() ;
//    _pressure_3TEC.text = _as.aggr.pressure_3.psi.toString() ;
//    _pressure_4TEC.text = _as.aggr.pressure_4.psi.toString() ;  /* Heat exchanger */
//
//
//    if (! _as.hasListeners) {
...
//
//    // Remember that you are preserving the ThermoScreenAppState outside of this context; it is held
...
//
//  @override
//  didUpdateWidget(ThermoScreenWidget oldWidget) {
//
...
//      appBar: AppBar(title: Text('Thermo System')),
...
//}
//
//class ThermoScreenWidget extends StatefulWidget {
//  @override
