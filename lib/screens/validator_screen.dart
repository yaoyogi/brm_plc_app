...
use a ChangeNotifier with the app state.  Note ValidatorScreenAppState extends ChangeNotifier and calls
...
class ValidatorScreenAppState extends ChangeNotifier {
...
class _ValidatorScreenEphemeralState extends State {
  ValidatorScreenAppState _as ;  // Filled in _appStateBuild()
...
//        _buildValveToggleButtons2(),
  ...
  _appStateBuild() {
    ...
    _as = provider.validatorScreenAppState ;
  ...
  dispose() {
    ...
    // Remember that you are preserving the ValidatorScreenAppState outside of this context; it is held
  ...
  @override
  didUpdateWidget(ValidatorScreenWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold scaff = Scaffold(
      appBar: AppBar(title: Text('Validator')),
...
class ValidatorScreenWidget extends StatefulWidget {
  @override
  _ValidatorScreenEphemeralState createState() {
    return _ValidatorScreenEphemeralState();
  }
}
