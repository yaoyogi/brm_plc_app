...
use a ChangeNotifier with the app state.  Note HelpScreenAppState extends ChangeNotifier and calls
...
class HelpScreenAppState extends ChangeNotifier {
...
class _HelpScreenEphemeralState extends State {
  HelpScreenAppState _as ;  // Filled in _appStateBuild()
...
//        _buildValveToggleButtons2(),
  ...
  _appStateBuild() {
    ...
    _as = provider.helpScreenAppState ;
  ...
  dispose() {
    ...
    // Remember that you are preserving the HelpScreenAppState outside of this context; it is held
  ...
  @override
  didUpdateWidget(HelpScreenWidget oldWidget) {
...
class HelpScreenWidget extends StatefulWidget {
  @override
  _HelpScreenEphemeralState createState() {
    return _HelpScreenEphemeralState();
  }
}
