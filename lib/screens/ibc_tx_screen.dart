...
//use a ChangeNotifier with the app state.  Note IBCTransferScreenAppState extends ChangeNotifier and calls
...
//
//class IBCTransferScreenAppState extends ChangeNotifier {
...
//  IBCTransferScreenAppState _as ;  // Filled in _appStateBuild()
//
//  //
//  // Ephemeral State
//  //
...
//    _as = provider.ibcTransferScreenAppState ;
//
//    //
//    // General
//    //
...
//
//    // Remember that you are preserving the IBCTransferScreenAppState outside of this context; it is held
...
//
//  @override
//  didUpdateWidget(IBCTransferScreenWidget oldWidget) {
//
...
//      appBar: AppBar(title: Text('IBC Transfer System')),
...
//}
//
//class IBCTransferScreenWidget extends StatefulWidget {
//  @override
